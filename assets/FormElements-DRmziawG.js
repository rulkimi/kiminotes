...
`);return(w,c)=>(a(),H(E,null,{subtitle:S(()=>[U(" Form elements with set of styles and props. ")]),content:S(()=>[n("div",Ie,[$e,v(B(L),{"hide-code":"","template-code":t.value,"file-name":"FormInput.vue"},{default:S(()=>[v(B(_),{label:"Label",id:"form-input",placeholder:"Placeholder",modelValue:x.value,"onUpdate:modelValue":c[0]||(c[0]=g=>x.value=g)},null,8,["modelValue"])]),_:1},8,["template-code"]),Oe,v(B(L),{"hide-code":"","template-code":u.value,"file-name":"FormTextarea.vue"},{default:S(()=>[v(B(Be),{label:"Label",id:"form-textarea",placeholder:"Placeholder",modelValue:x.value,"onUpdate:modelValue":c[1]||(c[1]=g=>x.value=g)},null,8,["modelValue"])]),_:1},8,["template-code"]),Me,v(B(L),{"hide-code":"","template-code":p.value,"file-name":"FormSelect.vue"},{default:S(()=>[v(B(ge),{label:"Label",modelValue:d.value,"onUpdate:modelValue":c[2]||(c[2]=g=>d.value=g),id:"form-select",placeholder:"Select an option",options:["Hello","My name"]},null,8,["modelValue"])]),_:1},8,["template-code"])])]),_:1}))}};export{Ee as default};
