...
`);return(M,m)=>{const n=L("font-awesome-icon");return g(),I(V,null,{subtitle:s(()=>[c(" Tooltip component with Tailwind CSS. ")]),content:s(()=>[t("div",q,[Y,l(a(_),{"template-code":b.value,"file-name":"Tooltip.vue"},{default:s(()=>[l(a(h),{content:"I'm hovered"},{default:s(()=>[J]),_:1})]),_:1},8,["template-code"]),X,F,l(a(_),{"template-code":v.value,"file-name":"Tooltip.vue"},{default:s(()=>[t("div",G,[t("div",Z,[l(a(h),{content:"I appear on left",direction:"left",theme:e.value},{default:s(()=>[K]),_:1},8,["theme"]),l(a(h),{content:"I appear on right",direction:"right",theme:e.value},{default:s(()=>[Q]),_:1},8,["theme"]),l(a(h),{content:"I appear on top!",direction:"top",theme:e.value},{default:s(()=>[tt]),_:1},8,["theme"]),l(a(h),{content:"I appear on bottom!",direction:"bottom",theme:e.value},{default:s(()=>[et]),_:1},8,["theme"])]),t("div",null,[ot,t("div",st,[t("label",lt,[W(t("input",{type:"radio",id:"theme-light",value:"light","onUpdate:modelValue":m[0]||(m[0]=i=>e.value=i),class:"form-radio"},null,512),[[O,e.value]]),it]),t("label",at,[W(t("input",{type:"radio",id:"theme-dark",value:"dark","onUpdate:modelValue":m[1]||(m[1]=i=>e.value=i),class:"form-radio"},null,512),[[O,e.value]]),rt])])])])]),_:1},8,["template-code"]),nt,pt,l(a(_),{"template-code":x.value},{default:s(()=>[l(a(h),{content:"I have indigo background and white bolded text color!","custom-styles":"bg-indigo-500 text-white font-bold"},{default:s(()=>[dt]),_:1})]),_:1},8,["template-code"]),ct,ht,l(a(_),{"template-code":y.value},{default:s(()=>[l(a(h),{theme:"light",direction:"bottom"},{content:s(()=>[t("div",mt,[t("div",ft,[l(n,{icon:["fas","calendar-alt"],class:"text-green-500 mr-2"}),t("span",ut,"Today is "+P(new Date().toDateString())+". I can add icons!",1)]),gt,bt,vt,xt])]),default:s(()=>[yt]),_:1})]),_:1},8,["template-code"])])]),_:1})}}};export{St as default};
