...
`);return(C,V)=>(f(),h(p,{sublinks:r.value},{subtitle:i(()=>[o(" How to configure web history properly for deployment in github pages. ")]),content:i(()=>[e("div",g,[y,b,_,n(a(s),{"json-code":c.value,"file-name":"package.json"},null,8,["json-code"]),v,H,n(a(s),{"script-code":u.value,"file-name":"/router/index.js"},null,8,["script-code"]),k,j,n(a(s),{"script-code":l.value,"file-name":"vite.config.js"},null,8,["script-code"])])]),_:1},8,["sublinks"]))}};export{B as default};
