import{_ as I,r as s,c as C,w as i,o as a,a as o,b as d,d as t,T as u,e as n,f,F as _,t as g,p as T,g as P}from"./index-DT574WOy.js";import{P as j}from"./PageLayout-CQ0-AiXR.js";import{_ as B}from"./PreviewBlock-CxH5QsaL.js";const x=l=>(T("data-v-518632d2"),l=l(),P(),l),L={class:"grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2"},N=x(()=>t("span",{key:"title"},"No transition",-1)),S=["onClick"],$=x(()=>t("span",{key:"title",class:"text-nowrap"},[t("span",{class:"font-mono"},"appear"),o(" attribute")],-1)),V=["onClick"],A=x(()=>t("span",{key:"title"},"Transition",-1)),F=["onClick"],O={__name:"ListTransition",setup(l){const c=s([{id:1,name:"Apple"},{id:2,name:"Orange"},{id:3,name:"Watermelon"},{id:4,name:"Papaya"},{id:5,name:"Pineapple"}]),v=s([...c.value]),y=s([...c.value]),p=(m,k)=>{const e=m.findIndex(r=>r.id===k);e!==-1&&m.splice(e,1)},b=s(`<transition-group class="relative flex flex-col gap-1" name="list" tag="ul" appear>
  <li
