import{_ as I,r as s,o as a,c as C,w as i,a as n,b as d,d as t,T as u,e as l,f,F as g,u as T,t as _,p as P,g as j}from"./index-DZ3wKJZw.js";import{P as B}from"./PageLayout-CvfnPwJl.js";import{_ as L}from"./Tooltip.vue_vue_type_style_index_0_scoped_e920ed47_lang-B9oopjPO.js";const x=o=>(P("data-v-84c88f31"),o=o(),j(),o),N={class:"grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2"},S=x(()=>t("span",{key:"title"},"No transition",-1)),$=["onClick"],V=x(()=>t("span",{key:"title",class:"text-nowrap"},[t("span",{class:"font-mono"},"appear"),n(" attribute")],-1)),A=["onClick"],F=x(()=>t("span",{key:"title"},"Transition",-1)),O=["onClick"],W={__name:"ListTransition",setup(o){const c=s([{id:1,name:"Apple"},{id:2,name:"Orange"},{id:3,name:"Watermelon"},{id:4,name:"Papaya"},{id:5,name:"Pineapple"}]),v=s([...c.value]),y=s([...c.value]),p=(m,k)=>{const e=m.findIndex(r=>r.id===k);e!==-1&&m.splice(e,1)},b=s(`<transition-group class="relative flex flex-col gap-1" name="list" tag="ul" appear>
  <li
