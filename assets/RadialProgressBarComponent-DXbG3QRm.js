import{P as y}from"./PageLayout-CvfnPwJl.js";import{_ as x}from"./Tooltip.vue_vue_type_style_index_0_scoped_e920ed47_lang-B9oopjPO.js";import{_ as k,i as l,y as b,o as h,e as v,d as e,n as w,t as z,z as _,r as u,c as B,w as m,a as P,b as c,u as n}from"./index-DZ3wKJZw.js";const S=["viewBox"],$=["cx","cy","r"],N=["cx","cy","r","stroke-dasharray","stroke-dashoffset"],C=["x","y"],g=10,M={__name:"RadialProgressBar",props:{size:{type:Number,default:60},color:{type:String,default:"text-primary"},radius:{type:Number,default:40},progress:{type:Number,default:0}},setup(t){const s=t,o=l(()=>Math.min(100,Math.max(0,s.progress))),a=l(()=>Number((2*Math.PI*s.radius).toFixed(1))),p=l(()=>a.value-a.value*o.value/100),r=l(()=>s.radius*2+g*2),d=b(),i=l(()=>d.isDarkMode?"#F3F4F6":"#000000");return(E,j)=>(h(),v("div",{style:_({width:`${t.size}px`,height:`${t.size}px`})},[(h(),v("svg",{viewBox:`0 0 ${r.value} ${r.value}`},[e("circle",{class:"text-gray-200 stroke-current","stroke-width":g,cx:r.value/2,cy:r.value/2,r:s.radius,fill:"transparent"},null,8,$),e("circle",{class:w(["progress-ring__circle stroke-current",t.color]),"stroke-width":g,"stroke-linecap":"round",cx:r.value/2,cy:r.value/2,r:s.radius,fill:"transparent","stroke-dasharray":a.value,"stroke-dashoffset":p.value},null,10,N),e("text",{x:r.value/2,y:r.value/2,"font-size":"16","text-anchor":"middle","alignment-baseline":"middle",style:_({fill:i.value})},z(o.value)+"% ",13,C)],8,S))],4))}},f=k(M,[["__scopeId","data-v-a5b2982e"]]),R={class:"flex flex-col gap-4"},D=e("h3",{class:"text-lg font-bold sublink"},"The component code",-1),F={class:"flex flex-col md:flex-row gap-4"},I={class:"flex gap-4"},W=e("h3",{class:"text-lg font-bold sublink"},"How to use?",-1),T=e("p",null,"Import in the component you want to use and configure the props.",-1),O=`<script setup>
